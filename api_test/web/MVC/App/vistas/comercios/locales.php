...
<div class="botones_activos d-flex justify-content-center gap-2 pb-2">
    <a href="<?php echo RUTA_URL; ?>/comercios/negocios" class="boton_activo btn btn-secondary">Negocios</a>
    <a href="<?php echo RUTA_URL; ?>/comercios/locales" class="boton_activo btn btn-dark active">Locales</a>
</div>
