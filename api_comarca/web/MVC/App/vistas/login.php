...
<main>
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <a href=".." class="btn btn-secondary mt-3 pt-3">
    ...
    <form action="<?php RUTA_URL ?>" method="POST" class="needs-validation" novalidate>
        <div class="d-flex align-items-center mt-5">
            <div class="container-fluid col-10 col-md-8 col-lg-6 col-xl-4 p-5 text-center border rounded border-dark">
                ...
                <div class="form-floating mt-3 mb-3">
                    <input type="password" class="form-control" id="login_password" placeholder="Contraseña" required>
